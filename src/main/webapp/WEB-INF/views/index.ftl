...
<body>
	<#include "/nav_footer.ftl"/>
	<div id="refresh_container" class="mui-content mui-scroll-wrapper">
		<div id="index_tabbar" class="mui-scroll mui-control-content mui-active">
			<ul class="mui-table-view mui-table-view-chevron" id="index_template_contener">
